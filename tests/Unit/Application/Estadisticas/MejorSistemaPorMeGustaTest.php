...
final class MejorSistemaPorMeGustaTest extends TestCase
{
    ...
    {
        return [
            // TikTok: 2 publicaciones, meGusta 12000 + 8000 = 20000, media 10000
            new Publicacion(
                usuarioId: 1,
                fecha: '2024-01-15',
            ...
            // Reels: 1 publicación, meGusta 5000, media 5000
            new Publicacion(
                usuarioId: 1,
                fecha: '2024-03-10',
